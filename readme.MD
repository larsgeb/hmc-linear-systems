...
# Hamiltonian Monte Carlo \r\r Probabilistic inversion of linear models
...
```
 python chain.py inversionFolder/samplesFile.txt
```
...
```
 python inference.py inversionFolder/samplesFile.txt
```
